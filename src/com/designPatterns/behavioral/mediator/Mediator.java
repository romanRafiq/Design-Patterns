...
public void registerSwedishBusyer(SwedishBuyer SwedishBuyer)
{
...
public boolean placeBid(float bid,String unitOfCurrrency)
{
	float dollarAmount = dollarConverter.convertCurrencyToDollars(bid,unitOfCurrrency);
